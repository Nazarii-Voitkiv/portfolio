  ...
  return (
    <div className="min-h-screen bg-[#0a192f] relative">
      ...
      <div className="container mx-auto px-6 py-12 max-w-5xl relative z-20">
        ...
        <div className="mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-100 mb-4">Freight Services Landing</h1>
          <div className="flex items-center gap-3 text-gray-400">
            <span className="text-xl">Freight Work & Handyman Services</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-10 mb-12">
          <div className="text-gray-400">
            ...
            <p className="mb-5 text-lg">
              A fully functional, responsive landing page developed on request for a client to showcase freight work and handyman services in Lviv. The site provides an intuitive interface for users to browse services, request quotes, and receive instant Telegram notifications.
            </p>
              ...
              <div className="flex-1 border border-gray-700 rounded-lg p-6 bg-gray-800/10 hover:bg-gray-800/20 transition-colors">
                ...
                <ul className="space-y-2 pl-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span><span className="text-gray-100">Next.js 14</span> – Server-side rendering & performance optimization</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">TypeScript</span> – Type safety and code reliability</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">Tailwind CSS</span> – Fast and adaptive UI styling</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">Framer Motion</span> – Smooth animations and transitions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">React Icons</span> – Enhanced UI with visual elements</span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <a 
                        href="https://pro-vse-web-site.vercel.app" 
                      ...
                      <div className="mt-2">
                        <a 
                          href="https://github.com/Nazarii-Voitkiv/PROVse-web-site" 
                          className="inline-flex items-center gap-2 text-[rgb(134,231,212)] hover:underline"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
