      ...
      <div className="container mx-auto px-6 py-12 max-w-5xl relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-10 mb-12">
          ...
          <div className="text-gray-400">
            ...
            <h2 className="text-2xl font-semibold text-gray-100 mb-4">Development Approach</h2>
            <p className="mb-4">
              The project utilized an NX monorepo architecture to streamline development between frontend and backend components, enabling shared types, efficient testing, and simplified deployment processes.
            </p>
            <p className="mb-4">
              The Angular frontend used a component-based architecture with Tailwind CSS and DaisyUI for rapid UI development. The Spring Boot backend provided a robust foundation for API development with comprehensive security measures through OAuth2 and Spring Security.
            </p>
          </div>
        </div>
