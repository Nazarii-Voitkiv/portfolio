  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 py-12 max-w-5xl relative z-20">
        ...
        {/* Project title */}
        <div className="mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-100 mb-4">Cybersecurity Education Platform</h1>
            ...
            <div className="flex flex-col md:flex-row gap-8 my-12">
              ...
              <div className="flex-1 border border-gray-700 rounded-lg p-6 bg-gray-800/10 hover:bg-gray-800/20 transition-colors">
                ...
                <ul className="space-y-2 pl-2">
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">JWT Tokens</span> – Secure authentication system</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">bcrypt</span> – Password hashing for enhanced security</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">Protected Admin Panel</span> – Secure access control</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-400 mt-1">•</span>
                    <span><span className="text-gray-100">Content Security</span> – Protection against common web vulnerabilities</span>
                  </li>
                </ul>
              </div>
